defmodule Flick.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule FlickWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :flick

       ...

       plug PromEx.Plug, prom_ex_module: Flick.PromEx
  ...
  def dashboards do
    [
      ...
      # {:flick, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
